    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_tracking_id', models.CharField(blank=True, default=None, max_length=32, null=True, unique=True)),
                ('registration_id', models.TextField(verbose_name='Registration token')),
                ('device_type', db.models.fields.choice.ChoiceCharEnumField(max_length=8)),

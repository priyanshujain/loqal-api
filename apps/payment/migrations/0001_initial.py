    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(default="NOT_SENT", max_length=128),
                ),
                (
                    "correlation_id",
                    models.CharField(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="paymentregister_created_by_user",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="paymentregister_deleted_by_user",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="paymentregister_updated_by_user",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],

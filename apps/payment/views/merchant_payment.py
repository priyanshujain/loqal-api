...
class MerchantCustomersAPI(MerchantAPIView):
    def get(self, request):
        merchant_account = request.merchant_account
        customers_response = get_merchant_customers(merchant_account=merchant_account)
...
class MerchantCustomerDetailsAPI(MerchantAPIView):
    def get(self, request, customer_id):
        merchant_account = request.merchant_account
        customer_data = get_customer_details(merchant_account=merchant_account, customer_id=customer_id)

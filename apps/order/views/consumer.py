...
from apps.order.dbapi import get_orders_in_period, get_empty_orders
...
class RewardedMerchantsAPI(ConsumerAPIView):
    def get(self, request):
        ...
        for loyalty_program in loyalty_programs:
            merchant = MerchantBasicDetailsResponse(loyalty_program.merchant).data
            ...
            if orders.exists():
                ...
                merchant["last_used_at"] = orders.first().created_at.isoformat()
            else:
